...
export function AssetsList({ accounts, btcPrice, currency, onRefresh }: Props) {
  ...
  return (
    <div className="bg-[#111] border border-white/5 rounded-2xl overflow-hidden">
      ...
      {showAdd && <AccountFormModal onClose={() => setShowAdd(false)} onSaved={onRefresh} />}
      {editing && <AccountFormModal existing={editing} onClose={() => setEditing(null)} onSaved={onRefresh} />}
    </div>
  )
}
